                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          <Textarea
                            ...
                            rows={2}
                          />
                          <Button onClick={sendSupportReply} disabled={!replyMessage.trim()}>
                            <Send className="h-4 w-4" />
                          </Button>
                        </div>
                      </>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input defaultValue="أزهاريون" />
                  </div>
                  <div className="space-y-2">
                    <Label>البريد الإلكتروني للدعم</Label>
                    <Input defaultValue="alyedaft@gmail.com" />
                  </div>
                  <div className="space-y-2">
                    <Label>رقم الهاتف</Label>
                    <Input defaultValue="01223909712" />
                  </div>
